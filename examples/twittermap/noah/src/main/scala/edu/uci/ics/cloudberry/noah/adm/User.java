...
public class User {
    ...
    public static String toADM(JsonNode rootNode) throws Exception{
        ...
        if (!userNode.isNull()) {
            ...
            ADM.keyValueToSbWithComma(userSB, User.NAME, ADM.mkQuoteOnly(userNode.path("name").asText()));
            ...
            ADM.keyValueToSbWithComma(userSB, User.LOCATION, ADM.mkQuoteOnly(userNode.path("location").asText()));
            ADM.keyValueToSbWithComma(userSB, User.CREATE_AT, ADM.mkDateStringFromTweet(userNode.path("created_at").asText()));
            ADM.keyValueToSbWithComma(userSB, User.DESCRIPTION, ADM.mkQuoteOnly(userNode.path("description").asText()));
